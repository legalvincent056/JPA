...
public class Adresse {
	...
	@OneToMany(mappedBy="adresse") //on met mappedBy du coté de l'esclave - toujours du coté unique OneToMany- Si on supprime adresse, le contact ne sait plus d'où il vient. 
